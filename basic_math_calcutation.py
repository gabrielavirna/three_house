"""Practice Basic Math Calculations in Python - The Solution"""
...
if turn_25 > current_year:
    print("You'll be 25 in the year {}, {}".format(turn_25, name))

if turn_50 > current_year:
    print("You'll be 50 in the year {}, {}".format(turn_50, name))

if turn_75 > current_year:
    print("You'll be 75 in the year {}, {}".format(turn_75, name))

if turn_100 > current_year:
    print("You'll be 100 in the year {}, {}".format(turn_100, name))
